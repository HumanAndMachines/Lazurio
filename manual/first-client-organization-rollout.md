...
1. Organization `AGENTS.md` — první neprázdný řádek je heading
   **Povinný handoff** a soubor obsahuje celou dvojotázku „Mám změny
   Publikovat tvým jménem? Nebo mám požádat jiného oprávněného Principála
   o kontrolu a Publikaci?". Nested soubory tenhle kontrakt nenahrazují.
